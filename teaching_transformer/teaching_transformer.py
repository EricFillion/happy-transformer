...
class TeachingTransformer:
    """
    A class for running a program that helps teach people English by giving them instant feedback
    on the words they use to form sentences.
    ...
    def __init__(self, transformer):
        ...
        :param transformer: A HappyTransformer class
        """
    ...
    def __predict_last_word(self, text: str):
        ...
        text = text.strip()
        text = text + " [MASK]"
        predictions = self.transformer.predict_mask(text, k=400)
        ...
        for prediction in predictions:
            ...
            if word.isalpha() == True or word in special_characters:
                ...
                score_predictions.append(prediction["score"])
                count += 1
                if count == 200:
                    break
    ...
    def teach(self):
        ...
        """
        sample_starts = ["To solve world hunger we must", "Humans are for"]
